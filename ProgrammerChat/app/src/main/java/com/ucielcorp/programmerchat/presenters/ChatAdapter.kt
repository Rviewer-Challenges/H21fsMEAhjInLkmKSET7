...
import com.ucielcorp.programmerchat.modals.Chat
...
class ChatAdapter(val chatClick: (Chat) -> Unit): RecyclerView.Adapter<ChatAdapter.ChatViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: ChatViewHolder, position: Int) {
        ...
        holder.itemView.userText.text = chats[position].userName
        holder.itemView.lastedMessageText.text = chats[position].lastMessage
